package com.prometheus.project.tool.gen.controller;
...
import com.prometheus.project.tool.gen.service.IGenTableColumnService;
import com.prometheus.project.tool.gen.service.IGenTableService;
...
public class GenController extends BaseController {
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"prometheus.zip\"");

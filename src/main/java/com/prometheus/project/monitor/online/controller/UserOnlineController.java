package com.prometheus.project.monitor.online.controller;
...
import com.prometheus.project.monitor.online.domain.OnlineSession.OnlineStatus;
...
public class UserOnlineController extends BaseController {
    ...
    public AjaxResult batchForceLogout(@RequestParam("ids[]") String[] ids) {
        for (String sessionId : ids) {
            ...
            online.setClientId(getSysUser().getClientId());

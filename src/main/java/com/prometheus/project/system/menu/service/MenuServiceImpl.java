package com.prometheus.project.system.menu.service;
...
import com.prometheus.common.utils.TreeUtils;
import com.prometheus.common.utils.security.ShiroUtils;
import com.prometheus.framework.web.domain.Ztree;
import com.prometheus.project.system.menu.domain.Menu;
import com.prometheus.project.system.menu.mapper.MenuMapper;
...
public class MenuServiceImpl implements IMenuService {
    ...
    public List<Ztree> roleMenuTreeData(Role role) {
        ...
        User user = ShiroUtils.getSysUser();
        if (user.isAdmin()) {
            menuList = menuMapper.selectMenuNormalAllWithButton();//查询正常显示的所有菜单及按钮
        } else {
            menuList = menuMapper.selectMenuAllByUserId(user.getUserId());
        }
    ...
    public int updateMenu(Menu menu) {
        ...
        ShiroUtils.clearCachedAuthorizationInfo();
//        menu.setClientId(ShiroUtils.getSysUser().getClientId());
        //修改菜单隐藏或者显示的时候，要把下面的按钮等也要修改掉
        menuMapper.updateMenuByParentId(menu);

package com.prometheus.framework.shiro.web.filter;
        ...
        try {
            ...
            try {
                ...
                if (StringUtils.isNotNull(user)) {
                    ...
                    // 记录用户退出日志
                    AsyncManager.me().execute(AsyncFactory.recordLoginInfo(loginName, clientId, Constants.LOGOUT, MessageUtils.message("user.logout.success")));
                    // 清理缓存

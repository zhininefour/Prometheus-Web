...
create table sys_client (
   client_id            int(11) not null auto_increment comment '客户机构id',
   client_name          national varchar(30) comment '机构名称',
   order_num            int(4) default 0 comment '显示顺序',
   leader               national varchar(20) comment '负责人',
   phone                national varchar(11) comment '联系电话',
   email                national varchar(50) comment '邮箱',
   longitude            decimal(18, 6) comment '经度',
   latitude  			decimal(18, 6) comment '纬度',
   valid_start_time       national varchar(20) comment '有效期开始时间',
   valid_end_time         national varchar(20) comment '有效期结束时间',
   status               national char(1) default '0' comment '机构状态（0正常 1停用）',
   del_flag             national char(1) default '0' comment '删除标志（0代表存在 2代表删除）',
   create_by            national varchar(64) comment '创建者',
   create_time           datetime comment '创建时间',
   update_by            national varchar(64) comment '更新者',
   update_time          datetime comment '更新时间',
   primary key (client_id)
) engine=innodb auto_increment=200 comment = '客户机构表';
...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '科技',   0, '', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00');
...
create table sys_user (
  client_id         int(11)         not null                   comment '客户机构id',
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(0, 1,  103, 'admin', '', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '管理员');
insert into sys_user values(0, 2,  105, 'ry',    '', '00', 'ry@qq.com',  '15666666666', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '0', '127.0.0.1', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '测试员');
...
-- 初始化-角色信息表数据
-- ----------------------------
insert into sys_role values(0, '1', '管理员',   'admin',  1, 1, '0', '0', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '管理员');
insert into sys_role values(0, '2', '普通角色', 'common', 2, 2, '0', '0', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '普通角色');
...
-- 二级菜单
insert into sys_menu values('116',  '客户机构', '1', '0', '/system/client',        '', 'C', '0', 'system:client:view',       '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '机构管理菜单');
...
insert into sys_menu values('101',  '角色管理', '1', '1', '/system/role',          '', 'C', '0', 'system:role:view',         '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '角色管理菜单');
...
-- 客户机构按钮
insert into sys_menu values('1062', '客户机构查询', '116', '1', '#', '',  'F', '0', 'system:client:list',     '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
insert into sys_menu values('1063', '客户机构新增', '116', '2', '#', '',  'F', '0', 'system:client:add',     '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
insert into sys_menu values('1064', '客户机构修改', '116', '3', '#', '',  'F', '0', 'system:client:edit',   '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
insert into sys_menu values('1065', '客户机构删除', '116', '4', '#', '',  'F', '0', 'system:client:remove',  '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
